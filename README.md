...
This was written for use for storing and displaying text on harware with modest capability (The Gameboy Advance in specific). An [example GBA Homebrew impmentation can be found here](https://github.com/sDiamond123/LTE_GBA_2/):
